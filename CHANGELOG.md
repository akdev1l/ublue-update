...
* try ([8354611](https://github.com/akdev1l/ublue-update/commit/83546110e42f5049e5d32eb9a2e0fc231b44b29f))
...
* added custom notification_manager to replace notify2 ([4b25c7c](https://github.com/akdev1l/ublue-update/commit/4b25c7c97a5f1f44a5d32e6df3a000e44cb02cfd))
* added NotificationObject, holds all notification data and makes it easier to deal with actions ([f67e3c9](https://github.com/akdev1l/ublue-update/commit/f67e3c905ae1ff19b988787cba6023cf410946ac))
* Implement system update check module and notification ([39f998b](https://github.com/akdev1l/ublue-update/commit/39f998bc38ebfabe83d71427d47d62cefc0fe77a))
...
* moved all dbus and glib logic into notification_manager ([d69ac11](https://github.com/akdev1l/ublue-update/commit/d69ac116351ce09a3839ea245f95998a3faa1e89))
* moved config format to toml, cleaned up config logic to default to /usr/etc ([2c47f12](https://github.com/akdev1l/ublue-update/commit/2c47f12d942b9b2c79c277369c9f015af67fd15d))
* removed dependency on notify2 ([dc3325e](https://github.com/akdev1l/ublue-update/commit/dc3325e45aaafad6c9afe174b16971d66aef347a))


### Bug Fixes

* add documentation to clean target ([308c17c](https://github.com/akdev1l/ublue-update/commit/308c17cd537d02796c01b0721bb2bd2af36c5414))
* add documentation to clean target ([#34](https://github.com/akdev1l/ublue-update/issues/34)) ([14ad321](https://github.com/akdev1l/ublue-update/commit/14ad321cdaf35dcb5609b9199110aa7fd6b52beb))
* add extra spacing to please code formatter ([99fa0a3](https://github.com/akdev1l/ublue-update/commit/99fa0a370894001860b9333d1390985f93523fee))
* add release-please on push ([9db575c](https://github.com/akdev1l/ublue-update/commit/9db575c60dff0ac4d708406c9cbfcb6f101611f2))
* added back Containerfile.builder to fix build action ([abf152e](https://github.com/akdev1l/ublue-update/commit/abf152ee44a36dbd5bbdb233fbd01c271c1abb3c))
* added import for DBusGMainLoop ([476c872](https://github.com/akdev1l/ublue-update/commit/476c872c58783487b9a045f1d2718590e7660543))
* Adjust update service and timer ([2dc0ccc](https://github.com/akdev1l/ublue-update/commit/2dc0ccc80cdaa850c7acd2729e883118e2212ad5))
...
* build rpm in release workflow ([#38](https://github.com/akdev1l/ublue-update/issues/38)) ([c1517cc](https://github.com/akdev1l/ublue-update/commit/c1517ccd183fb0f67380ba4d8af68f1b358240ac))
* Check if the url already contains the protocol during update checks ([829af56](https://github.com/akdev1l/ublue-update/commit/829af5643a599789be1b86e3ec45cbb00b8aa3f0))
* Check if the url already contains the protocol during update checks ([#44](https://github.com/akdev1l/ublue-update/issues/44)) ([66ac29c](https://github.com/akdev1l/ublue-update/commit/66ac29c2c455b47ba3ee110c3716cad635d02e97))
* **cli:** Remove residual semicolon from testing ([83b39d7](https://github.com/akdev1l/ublue-update/commit/83b39d707ce6c382883cc835fe11a692fe9c1e44))
* **config:** fix breakage when using fallback config, improved config logic to be more flexible ([f167dc9](https://github.com/akdev1l/ublue-update/commit/f167dc970d7b38e4ecf6d85895e800ce16760063))
* fix program exiting telling user checks have failed when running from notification ([7b24b8c](https://github.com/akdev1l/ublue-update/commit/7b24b8cb4b31a2406c55cc88e60a9a90bda1b173))
* fix program exiting telling user checks have failed when running from notification ([#43](https://github.com/akdev1l/ublue-update/issues/43)) ([2b42c62](https://github.com/akdev1l/ublue-update/commit/2b42c628660f3fa5999d8eb1542c919b9c44a087))
* fix updater throwing exception when dbus is inactive ([ee226b7](https://github.com/akdev1l/ublue-update/commit/ee226b7cfd164ec71487ea73b476eb8213775fb4))
* fixed and simplified argument behavior, use better naming ([3068671](https://github.com/akdev1l/ublue-update/commit/30686717c4e8ad5c4b369694d8f147718efa6656))
* fixed issues that prevented script from running, removed commented out code ([22b83c8](https://github.com/akdev1l/ublue-update/commit/22b83c850bf8dcb5dbba008f209a3f7705dc7579))
* fixed line length and corrected variable reference ([864e2ea](https://github.com/akdev1l/ublue-update/commit/864e2ea14872ca7c3d5b2f7b4d5848553425547f))
* formatting ([2a25ca0](https://github.com/akdev1l/ublue-update/commit/2a25ca02bbf18d1b8911107f04bb0f753783f115))
...
* import notification_manager module properly ([ebc387f](https://github.com/akdev1l/ublue-update/commit/ebc387fadfafefdc024b071fac54d8269a648902))
* Just drop the registry reference in URL for latest image ([d6b9e37](https://github.com/akdev1l/ublue-update/commit/d6b9e3750a46e9b102590f8f48eb6d13b575aff5))
* Just drop the registry reference in URL for latest image ([#47](https://github.com/akdev1l/ublue-update/issues/47)) ([00e8724](https://github.com/akdev1l/ublue-update/commit/00e87240721f93f91f50b4d612f9c855b08c22a1))
* make -c option work as intended ([c743b98](https://github.com/akdev1l/ublue-update/commit/c743b9844e1455ba07e33b159afee6c8a931f9df))
...
* move update logging into run_updates() function ([cb309ac](https://github.com/akdev1l/ublue-update/commit/cb309ac12863ac72fbbbe95372bbed542c16ecdf))
...
* **notifications:** Handle actions properly ([763256a](https://github.com/akdev1l/ublue-update/commit/763256afa27f0edbed2e7bea96ccb4650e59b288))
* Properly pull URL and tag from current image ([b0a35a2](https://github.com/akdev1l/ublue-update/commit/b0a35a2b1bc9d674cc651200afc0796bcdfc9150))
* Properly pull URL and tag from current image ([#46](https://github.com/akdev1l/ublue-update/issues/46)) ([aedb3cb](https://github.com/akdev1l/ublue-update/commit/aedb3cb8e55a8c64ce6580d9e8a3210500ca17ab))
* reformat ([083a87a](https://github.com/akdev1l/ublue-update/commit/083a87a867bad87afc421e102031aaeff1f63b42))
* reformat to please the formatting gods ([38a18ec](https://github.com/akdev1l/ublue-update/commit/38a18ecbbf5a6c3bffeafc4d5e1668b4271d8d39))
...
* remove build remnent from git ([0e2fe81](https://github.com/akdev1l/ublue-update/commit/0e2fe8197cdc5b9a0debc61f07c5d209c7c8bf6e))
* remove ignores for **.md and **.txt ([837f0d5](https://github.com/akdev1l/ublue-update/commit/837f0d55e8ba7e540621ac6d941beec1ea411526))
* remove notification when system passes checks when running with -c ([0e1fa6e](https://github.com/akdev1l/ublue-update/commit/0e1fa6eedd18a86cef6c98aa90685e06a77e42a8))
* remove unnecessary documentation ([f6aeb24](https://github.com/akdev1l/ublue-update/commit/f6aeb24041558649c45815ba0bde67171ebb576e))
* remove unnecessary documentation ([#36](https://github.com/akdev1l/ublue-update/issues/36)) ([96fc700](https://github.com/akdev1l/ublue-update/commit/96fc7008cdece6b728ed4734c9b49e633ca7ec61))
* remove unnecessary if statement ([704e80e](https://github.com/akdev1l/ublue-update/commit/704e80e12e1f33e618fca4b880d6efdbcb55c41f))
...
* removed exit() and print() function used for debugging ([2eca189](https://github.com/akdev1l/ublue-update/commit/2eca1892a262ff7b1381dfcecb65d27fa5cd203e))
* rename config file value to be loaded ([f5f7673](https://github.com/akdev1l/ublue-update/commit/f5f76732c8f2d7e37ca90e744b88430417fd2397))
...
* **systemd timer:** fixed spelling of persistent ([0c74fa2](https://github.com/akdev1l/ublue-update/commit/0c74fa24f8e7eab557fa7030571b671bee964b62))
* try to build release rpm ([83dfafa](https://github.com/akdev1l/ublue-update/commit/83dfafab19b46364aab689a4dc6b68d06f22f541))
* try to build release rpm ([#39](https://github.com/akdev1l/ublue-update/issues/39)) ([12b2ac2](https://github.com/akdev1l/ublue-update/commit/12b2ac2da57bfe35b29f96bf655365643c7a34cc))
* uncomment regular rpm output ([f32798f](https://github.com/akdev1l/ublue-update/commit/f32798fba0ecf87996eba049b48cbadeff7d3746))
...
* update ublue_update_version macro to match version with github tag ([60ad5fd](https://github.com/akdev1l/ublue-update/commit/60ad5fd263253d2759e8d359b6bae94f55fae7ae))
* update ublue_update_version macro to match version with github tag ([#49](https://github.com/akdev1l/ublue-update/issues/49)) ([f0bbc04](https://github.com/akdev1l/ublue-update/commit/f0bbc048556680f710fae4b3906f0244b9c043dc))
* use builder container file for release ([51b496a](https://github.com/akdev1l/ublue-update/commit/51b496a6a43ebfe3cb64ee5fbb2e308c79b9cb3c))
* use os._exit() instead of sys.exit() to completely kill program ([abca773](https://github.com/akdev1l/ublue-update/commit/abca7739599b6bbb0cbef7b7312aed69c84e846f))
...
* use version from the CHANGELOG.md so it is always in sync ([60c0fff](https://github.com/akdev1l/ublue-update/commit/60c0fff3e2ce494551250fb1792da25a8d8b8ea4))
